...
class addpanel8 extends JPanel
{
   ...
   public addpanel8()
    {
      	...
      	l18=new JLabel("Delete Record :",JLabel.CENTER);
  ...
  class DeleteRecord extends JFrame implements ActionListener
   {
	...
	public void actionPerformed(ActionEvent ae)
		...
		if(ae.getSource() == b3)
		 ...
		 if(ae.getSource() == b4)
		 {
                           		...
                           		ps=con.prepareStatement("Delete from admission where 		 	         crno=? "); 
		                ps.setInt(1,crno1);  
                           		ps.executeUpdate();
			...
			ap1.t1.setText("");
		          ...
		          ap1.t17.setText("");
              		...
              		JOptionPane.showMessageDialog(null,"Record Delete succefully",
